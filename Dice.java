    	...
    	*/
    	...
    	try{
			...
			//ダイスロール[xDy] or [xDy+z] or [xDy + yDu] 
				...
				case 2 : dice1 = Integer.parseInt(param[0]) ;
						 dice2 = Integer.parseInt(param[1]) ;
						 
			    	     dicePlay.diceRoll( dice1 , dice2 );
					break ;
				
					
				case 3 :  dice1 = Integer.parseInt(param[0]) ;
						  dice2 = Integer.parseInt(param[1]) ;
						  dice3 = Integer.parseInt(param[2]) ;
					
						  dicePlay.diceRoll(dice1,dice2,dice3);
					break ;
					
					
				case 4 :  dice1 = Integer.parseInt(param[0]) ;
						  dice2 = Integer.parseInt(param[1]) ;
						  dice3 = Integer.parseInt(param[2]) ;
